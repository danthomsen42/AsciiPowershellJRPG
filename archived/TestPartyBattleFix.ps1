...
# Quick test to validate the multi-party battle system fixes
...
try {
    ...
    Write-Host "1. Fixed New-PartyTurnOrder call: Wrapped enemy in array @(`$enemy)" -ForegroundColor White
